...
const Projects = () => {
    const [data, setData] = useState([
      {id: 1, name: 'test', department: 'test1', cost: '133', works_day: '5', price: '144', maintaince: '5'},
      {id: 2, name: 'test1', department: 'test2', cost: '113', works_day: '4', price: '124', maintaince: '3'},
    ])
